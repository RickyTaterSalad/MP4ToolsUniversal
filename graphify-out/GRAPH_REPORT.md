...
## Corpus Check
- 52 files · ~21,476 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 649 nodes · 1260 edges · 30 communities (26 shown, 3 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 38 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14baeca9`
...
8. `CombineFile` - 19 edges
9. `FfmpegOption` - 19 edges
10. `RecordingJsonElapsedOffset` - 18 edges
...
Cohesion: 0.10
Nodes (12): Exception, CancellationToken, JsonNode, Task, Action, CancellationToken, JsonElement, Task (+4 more)
...
Cohesion: 0.06
Nodes (28): AsyncRelayCommand, DateTime, ObservableCollection, RelayCommand, CombineViewModel, CanCombine, CombineCommand, CurrentInputFileSortMode (+20 more)
...
### Community 19 - ".RunEdgeRefreshAsync"
Cohesion: 0.25
Nodes (3): CancellationTokenSource, List, NotifyCollectionChangedEventArgs

### Community 21 - ".CreateAsync"
Cohesion: 0.21
...
### Community 22 - "DefaultOutputPathRuntime"
Cohesion: 0.40
...
## Knowledge Gaps
- **135 isolated node(s):** `net10.0`, `Avalonia (12.1.2)`, `Avalonia.Desktop (12.1.2)`, `Avalonia.Fonts.Inter (12.1.2)`, `Avalonia.Themes.Simple (12.1.2)` (+130 more)
...
- **Why does `CombineViewModel` connect `CombineViewModel` to `MP4ViewModelBase`, `.OnInputPathSet`, `.CombineInternal`, `LogViewModel`, `TimeRange`, `.OnPropertyChanged`, `.RunEdgeRefreshAsync`, `.SyncSelectedInputFiles`, `CombineView`, `.RefreshCanCombineFromInputs`, `MP4ToolsLib`?**
  _High betweenness centrality (0.292) - this node is a cross-community bridge._
- **Why does `MP4ToolsLib` connect `MP4ToolsLib` to `.PrependIntroAsync`, `MP4ViewModelBase`, `.CombineInternal`, `FFMpegUtils`, `BoxScoreUploader`, `DrawText Overlay Utils`, `TimeRange`, `EncodingSettingsDto`, `.CreateAsync`, `CombineView`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `TrimViewModel` connect `TrimViewModel` to `.PrependIntroAsync`, `MP4ViewModelBase`, `.CombineInternal`, `LogViewModel`, `TimeRange`, `ExportTrimState`, `StartStopRange`, `MP4ToolsLib`?**
